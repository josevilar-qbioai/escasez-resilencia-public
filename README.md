...
```bash
git clone https://github.com/josevilar-qbioai/escasez-resiliencia.git
cd escasez-resiliencia
...
El script `backtest.py` requiere CSVs de precios históricos con el formato:
...
- Discusión de propiedades: finitud del multiplicador, comportamiento en los límites, comparativa con modelos exponenciales
